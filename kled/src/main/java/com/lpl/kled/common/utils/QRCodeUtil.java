...
public class QRCodeUtil {
    ...
    public static void encode(String content, String imgPath,  
            OutputStream output, boolean needCompress,String fileName) throws Exception {  
        BufferedImage image = QRCodeUtil.createImage(content, imgPath,needCompress);  
    ...
    public static void encode(String content, OutputStream output,String fileName)  
            throws Exception {  
        QRCodeUtil.encode(content, null, output, false,fileName);  
    } 
    ...
    public static byte[] encode(String  content) throws Exception{
    	...
    	ImageIO.write(createImage(content,null,false),FORMAT_NAME,out);
    ...
    public static void main(String[] args) throws Exception {  
        //String content=QRCodeUtil.decode("D:/0__181145072308548.png");  
        //System.out.println("content = "+content);  
          
        //String text = "http://127.0.0.0:8888/Kled";  
        /*QRCodeUtil.encode(text,"c:/aa",false,"login.png");*/  
